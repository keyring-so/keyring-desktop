...
replace (
	...
	// github.com/centrifuge/go-substrate-rpc-client/v4 => github.com/keyring-so/go-substrate-rpc-client/v4 v4.3.3
	github.com/centrifuge/go-substrate-rpc-client/v4 => /Users/kaichaosun/github/keyring-so/go-substrate-rpc-client
